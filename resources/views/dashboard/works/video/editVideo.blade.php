                        ...
                        <div>
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="video[name]"
                                        placeholder="name of project" value="{{ $video['nameProject'] }}">
                                    @error('video[name]')
                            ...
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="video[path]" placeholder="Path of video " value="{{ $video['path'] }}">
                                    @error('video[0][path]')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-12 text-center " style="overflow: hidden">
                            <div class="col-md-6 mx-auto">
                                <button class="btn btn-info overflow-hidden" type="button">
                                    <input type="file" name="video[image]">
                                    <hr>
                                    <div class="image-size">
                                        <img class=" w-100 h-100 mx-auto" src="/works/video/{{ $video['image'] }}" alt="">
                                    </div>
                                </button>
                            </div>
                        </div>
