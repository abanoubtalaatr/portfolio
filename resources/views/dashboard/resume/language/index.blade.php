                        ...
                        @foreach ($language as $key => $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning" onclick="window.location='/dashboard/resume/language/edit/{{ $value['id'] }}'"> <i class="fas fa-edit"> </i></button>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title  text-danger" id="exampleModalLabel">Delete one language</h5>
